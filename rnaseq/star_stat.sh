...
RRNA=$REFDIR/genprime_vM7/genprime_vM7.rRNA_merged.intervals
GENOME=$REFDIR/genprime_vM7/genprime_vM7.fa
REFFLAT=$REFDIR/genprime_vM7/genprime_vM7.refFlat.txt
PICARD=$PGDIR/picard-tools-1.141
...
java -Xmx2g -jar $PICARD/picard.jar CollectRnaSeqMetrics INPUT=$BAMDIR/$TAG.bam OUTPUT=$TAG.picard.metrics REF_FLAT=$REFFLAT RIBOSOMAL_INTERVALS=$RRNA STRAND_SPECIFICITY=FIRST_READ_TRANSCRIPTION_STRAND REFERENCE_SEQUENCE=$GENOME
